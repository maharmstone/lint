...
#define MUWINE_IOCTL_NTDELETEVALUEKEY     MUWINE_IOCTL(7)
#define MUWINE_IOCTL_NTCREATEKEY          MUWINE_IOCTL(8)
#define MUWINE_IOCTL_NTDELETEKEY          MUWINE_IOCTL(9)
#define MUWINE_IOCTL_NTLOADKEY            MUWINE_IOCTL(10)
#define MUWINE_IOCTL_NTUNLOADKEY          MUWINE_IOCTL(11)
