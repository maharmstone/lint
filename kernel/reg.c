...
static bool get_user_unicode_string(UNICODE_STRING* ks, const __user UNICODE_STRING* us) {
    WCHAR* srcbuf;
...
static bool get_user_object_attributes(OBJECT_ATTRIBUTES* ks, const __user OBJECT_ATTRIBUTES* us) {
    UNICODE_STRING* usus;
